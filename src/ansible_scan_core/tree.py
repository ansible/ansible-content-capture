...
class TreeLoader(object):
    def __init__(
        ...
        # Ansible Scanner does not scan them by default, but it does when `load_all_taskfiles == True`
        ...
        # or, if the scan is for a single taskfile, Ansible Scanner just scans it
