...
def set_argument_key_details(task: TaskCall, ram_client: RAMClient=None):
    ...
    if task.spec.executable_type == ExecutableType.MODULE_TYPE and task.module and task.module.arguments:
        ...
        task.spec.set_annotation("module.wrong_arg_keys", wrong_keys)
        task.spec.set_annotation("module.available_arg_keys", available_keys)
        task.spec.set_annotation("module.required_arg_keys", required_keys)
        task.spec.set_annotation("module.missing_required_arg_keys", missing_required_keys)
        task.spec.set_annotation("module.available_args", available_args)
        task.spec.set_annotation("module.default_args", default_args)
        task.spec.set_annotation("module.used_alias_and_real_keys", used_alias_and_real_keys)
